...
def open3d_eye_to_end_trans(trans_pointcloud):
...
def open3d_eye_to_base_trans(trans_pointcloud_end):
...
def global_pointcloud_process(global_tmp_pointcloud, pointcloud_tmp_num, kmean_lines_in_global, global_tmp_pointcloud_bounding_box_min_obb):
    ...
    global_tmp_pointcloud_base = open3d_eye_to_base_trans(global_tmp_pointcloud_end)
...
def local_pointcloud_process(local_tmp_pointcloud, pointcloud_tmp_num):
    ...
    cl1, ind1 = local_tmp_pointcloud.remove_statistical_outlier(nb_neighbors=80, std_ratio=0.5)
    ...
    o3d.visualization.draw_geometries([local_tmp_pointcloud,
                                       ...
                                       axis_pcd,
                                       line_pcd], point_show_normal=True)
    ...
    local_tmp_pointcloud_base = open3d_eye_to_base_trans(local_tmp_pointcloud_end)
    o3d.io.write_point_cloud("pre_pointcloud/{}_base_{}.ply".format(pointcloud_tmp_name, pointcloud_tmp_num),
    ...
    return line_pcd, local_tmp_pointcloud_bounding_box_min_obb
        ...
        while True:
            ...
            if not seg_input_stop_laser and len(np.array(seg_input_label_laser_tmp)) > 100:
                ...
                if decision == "y" or decision == "n":
                    ...
                    kmean_lines, local_min_obb = local_pointcloud_process(local_pcl_points, k)
                    ...
                    global_pointcloud_process(global_pcl_points, k, structure_kmean_lines_for_def, local_min_obb)
